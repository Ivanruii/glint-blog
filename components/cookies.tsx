            ...
            <Card className="m-3">
                ...
                <CardContent>
                    <p className="text-sm font-normal text-start">
                        Utilizamos cookies para garantizarle la mejor experiencia en nuestro sitio web. Para obtener más información sobre cómo utilizamos las cookies, consulte nuestra política de cookies.
                        <br />
                        <span className="text-xs">Haciendo clic en "<span className="font-medium opacity-80">Aceptar</span>", aceptas el uso que hacemos de las cookies.</span>
                        <br />
                        <Link href={`/cookies`} className="text-xs underline">Ver politica de cookies.</Link>
                    </p>
                </CardContent>
